            ...
            <div class="col-lg-12">
                <div class="card product_item_list">
                    ...
                    <div class="d-flex justify-content-start mb-4">
                        <h4><a  href="{{ URL::to('/portal/dashboard') }}">Total of {{ $month_sale}} Orders</a></h4>
                    </div>
                    <div class="d-flex justify-content-start mb-4">
                ...
                <div class="card product_item_list">
                    ...
                    <table class="table table-hover m-b-0">
                        ...
                        <tfoot class="d-flex"><span class="d-flex justify-content-end mb-4" > <a href="receipts" class="btn btn-default"> <i class="zmdi zmdi-eye" style="margin-right: 3px;"></i> View Information</a></span></tfoot>
                    </div>
                </div>
