...
<section class="content home">
        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="{{route('landing')}}"><i class="zmdi zmdi-home"></i> Sahani</a>
                    </li>
    ...
    $sales = Order::with('menu')->where('restaurant_profile_id', $restaurant->id)->whereDate('created_at', Carbon::today())->get();

    $completed_orders = Order::with('menu')->where('restaurant_profile_id', $restaurant->id)->whereDate('created_at', Carbon::today())->where('Status',3)->count();
   // dd($now);
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                                ...
                                <div class="body">
                                    ...
                                    <h2 class="number count-to m-t-0 m-b-5" data-from="0" data-to="{{$menu->menu->pricing}}" data-speed="2000" data-fresh-interval="700">3</h2>
                                    <p class="text-muted ">Total Sales Todays</p>
                                    <span id="linecustom2">2,9,5,5,8,5,4,2,6</span>
                                </div>
                                @endforeach
