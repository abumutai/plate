      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"> Move Stock</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-success">
                <div class="card-header" style="background-color: indigo">
                  <h3 class="card-title" >Move Stock</h3>
                </div>
                <div class="card-body">
                @if (session('error'))
                ...
                @endif
                <form action="{{route('consumedstocks.store')}}" method="post">
                  @csrf
                  ...
                  <div class="form-group">
                      <button type="submit" class="btn btn-success btn-lg" style="background-color: indigo"> <i class="fa fa-plus"></i> Move</button>
                  </div>
                </form>
                </div>
              </div>
